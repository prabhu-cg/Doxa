  ...
  return (
    <LegalPageShell title="Privacy Policy" lastUpdated="9 September 2026">
      ...
      <p>
        ...
        personal information, and we don&apos;t run ad trackers on this site or
        in the product.
      </p>
      ...
      <ul>
        ...
        <li>
          Basic technical information — IP address, user agent and timestamps —
      ...
      <h2>How it&apos;s used</h2>
      <p>
        To provide the core product — collecting, discussing, prioritising and
        deciding on input within your organisation — and to keep the service
        secure, reliable and free of abuse. We do not use your content to train
        models or to advertise to you.
      </p>
      ...
      <p>
        ...
        whether they belong to that organisation — an account never sees another
        organisation&apos;s data.
      </p>
      ...
      <p>
        ...
        pixels, third-party trackers, or session-recording scripts on this site
        or in the product.
      </p>

      <h2>Data sharing and subprocessors</h2>
      <p>
        Doxa does not sell personal information. Content is shared only with the
        organisation it belongs to and the people in it, per that
        organisation&apos;s membership and roles. The infrastructure providers
        that process data on our behalf — currently Vercel (hosting) and
        Supabase (database and authentication) — are bound by their own data
        processing terms.
      </p>

      <h2>Data retention and your rights</h2>
      <p>
        Content persists for as long as your account or organisation is active.
        You can request export, correction or deletion of your personal data and
        account through the contact page — we&apos;ll respond directly rather
        than making you dig through settings that don&apos;t exist yet.
      </p>
